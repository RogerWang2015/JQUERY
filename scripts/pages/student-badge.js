...
(function () {
    ...
    var studentBadgePage = Object.inherit({
        
        initialize: function (element) {
            this.canvas = element.querySelector("canvas");
            this.busyElement = element.querySelector(".busy");
            
            this.studentId = this.canvas.getAttribute("data-student-id");
            this.studentName = this.canvas.getAttribute("data-student-name");
        ...
        drawBadge: function (image) {
            ...
            if (image) {
                this.drawstudentImage(image);
            } else {
                this.drawImagePlaceholder();
            }
            this.drawBarCode(this.studentId);
        },
        ...
        drawstudentImage: function (image) {
        ...
        drawTopText: function () {
            ...
            this.context.fillText("Trios 2015 student:", 200, 20);
        },

        drawstudentName: function () {
            this.context.font = "40px sans-serif";
            this.context.fillStyle = "black";
            this.context.textBaseline = "top";
            this.context.textAlign = "left";
            this.context.fillText(this.studentName, 200, 60);
        },
    ...
    studentBadgePage.create(badgeElement);
